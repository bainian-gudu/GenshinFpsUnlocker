...
import {
  ...
  PanelsTopLeft, Power, ScanLine, Shield, ShieldAlert, ShieldCheck,
                  ...
                  <div className="launch-actions">
                    ...
                    <button className={`button button-primary launch-button ${attachedPid > 0 ? 'is-running' : ''}`} onClick={handleLaunch} disabled={launchState === 'launching'}>
                      {launchState === 'launching'
                        ...
                        : <img className="launch-button-icon" src="/images/game-icon.webp" alt="" width={18} height={18} draggable={false} />}
