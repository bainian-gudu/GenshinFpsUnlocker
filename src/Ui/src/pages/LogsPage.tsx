...
export function LogsPage({ logs, onClear, onExport, isNative }: { logs: LogEntry[]; onClear: () => void; onExport: () => void; isNative?: boolean }) {
  ...
  return <>
    <PageHeading title="运行日志" description="每一步都有迹可循，让问题排查更简单。"><button className="button button-secondary" onClick={onExport} disabled={!logs.length}><Download size={15} />导出日志</button></PageHeading>
