import { ArrowUpRight, Code2, Heart, ShieldCheck } from 'lucide-react';
...
export function AboutPage({ onSafety, version = '1.0.0', isNative, onUninstall }: { onSafety: () => void; version?: string; isNative?: boolean; onUninstall?: () => void }) {
  return <>
    ...
    <div className="about-details"><section><h3><Code2 size={18} />为轻量而构建</h3><dl><div><dt>项目作者</dt><dd><a href="https://github.com/bainian-gudu" target="_blank" rel="noreferrer">bainian-gudu<ArrowUpRight size={12} /></a></dd></div><div><dt>支持平台</dt><dd>Windows 10 (1607+) / Windows 11 · x64</dd></div><div><dt>桌面运行时</dt><dd>.NET Desktop Runtime 9 · WebView2</dd></div><div><dt>开源许可</dt><dd><a href={`${PROJECT_URL}/blob/main/LICENSE`} target="_blank" rel="noreferrer">MIT License<ArrowUpRight size={12} /></a></dd></div></dl></section><section><h3><Heart size={18} />开放，让体验更好</h3><p>项目代码公开透明。欢迎提交问题、分享建议，或用一次 Pull Request 让它变得更好。</p><div className="about-text-links"><a href={`${PROJECT_URL}/issues`} target="_blank" rel="noreferrer">反馈问题<ArrowUpRight size={14} /></a><a href={`${PROJECT_URL}/pulls`} target="_blank" rel="noreferrer">参与贡献<ArrowUpRight size={14} /></a></div>{isNative && onUninstall && <button className="text-button muted preview-about-button" onClick={onUninstall}>卸载本软件</button>}</section></div>
    <div className="about-disclaimer"><ShieldCheck size={18} /><p>本项目为第三方工具，与米哈游 / HoYoverse 无关联。使用风险自负。<button className="text-button" onClick={onSafety}>查看安全声明</button></p></div>
  </>;
}