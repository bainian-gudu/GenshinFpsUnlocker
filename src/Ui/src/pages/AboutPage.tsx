...
export function AboutPage({ onSafety, version = '1.0.0', isNative, onUninstall }: { onSafety: () => void; version?: string; isNative?: boolean; onUninstall?: () => void }) {
  return <>
    ...
    <div className="about-disclaimer"><ShieldCheck size={18} /><p>本项目为第三方工具，与米哈游 / HoYoverse 无关联。使用风险自负。<button className="text-button" onClick={onSafety}>查看用户协议</button></p></div>
  </>;
}